...
class AudioRecorder:
    ...
    def record_chunks(self):
        ...
        while self.recording:
            ...
            chunk = sd.rec(int(self.sample_rate * 0.5), samplerate=self.sample_rate, channels=1, dtype=np.int16)
            sd.wait()
    ...
    def start_recording(self):
        try:
            ...
            self.recording_thread = threading.Thread(target=self.record_chunks, daemon=True)
